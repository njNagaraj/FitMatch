import { User, Sport, Activity, Event, Chat } from '../shared/types';
...
let activities: Activity[] = [
    ...
    {
        id: 'activity-7', sportId: 'sport-2', title: 'Guindy Park Cycling', creatorId: 'user-3',
...
// The database object that the services will interact with
export const db = {
    users,
    sports,
    activities,
